...
public class AverageProfit {
    public static void main(String[] args) throws Exception {
        ...
        DataStream < String > data = env.readTextFile(DATA_DIR + "/avg");
        ...
        DataStream < Tuple2 < String, Double >> profitPerMonth =
                reduced.map((MapFunction<Tuple5<String, String, String, Integer, Integer>, Tuple2<String, Double>>) input -> new Tuple2<String, Double>(input.f0, Double.valueOf((input.f3 * 1.0) / input.f4)));

        //profitPerMonth.print();
        profitPerMonth.writeAsText(DATA_DIR + "profit_per_month.txt");
